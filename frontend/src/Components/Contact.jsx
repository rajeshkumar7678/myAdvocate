            ...
            <div className="col-12 col-lg-10 mx-auto">
              <div className="row">
                <div className="contact-leftside col-12 col-lg-5">
                  ...
                  <figure>
                    <img
                      src="https://media.istockphoto.com/id/937346262/photo/group-of-confident-perky-lawyers-standing-together.jpg?s=612x612&w=0&k=20&c=S-gJ87ivA39DQ_gaLujkFOwJFbc9Ggu7dgPRSnCifLI="
                      alt="contatUsImg"
                      className="img-fluid"
                    />
                  </figure>
